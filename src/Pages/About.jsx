  ...
  return (
    <div className="min-h-screen bg-gray-100 py-10 px-4 sm:px-6 lg:px-20">
      <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-8">
        <h1 className="text-4xl font-bold  text-center">About Jalvix</h1>

        <p className="text-gray-700 text-lg">
          Welcome to{" "}
          <span className="font-semibold text-yellow-600">Jalvix</span>, your
        ...
        <div className="space-y-6">
          ...
          <p className="text-gray-700 text-base">
            At Jalvix, our mission is to make innovative technology accessible
        ...
        <div className="text-center mt-10">
          ...
          <p className="text-gray-700 mb-4">
            ...
            for something cool and functional — Jalvix has something for
            everyone.
          </p>
          <Link to={"/products"}>
            <button className="bg-yellow-600 text-white px-6 py-2 rounded-xl hover:bg-red-700 transition duration-300">
              Start Shopping
            </button>
          </Link>
        </div>
